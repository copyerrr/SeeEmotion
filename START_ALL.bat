...
echo ========================================
echo.
echo [1/3] 메인 FastAPI 서버 (포트 8000)
echo [2/3] 비디오 분석 서버 (포트 8002)
echo [3/3] Flutter 프론트엔드 (포트 3000)
echo.
...
REM 현재 스크립트의 디렉토리 경로 저장 (프로젝트 루트)
set SCRIPT_DIR=%~dp0
set BACKEND_DIR=%SCRIPT_DIR%backend
set FRONTEND_DIR=%SCRIPT_DIR%frontend\deaftv_lgdxschool_projects
